...
├── cmd/          # CLI command logic and main entrypoint
├── docs/         # Documentation (Astro/Starlight site and issues)
├── internal/     # Core application logic (errors, keepass integration, utils)
├── test/         # E2E test suites and test utilities
